...
public class Test {
	...
	{ 
	 ...
	 Customer cust1=new Customer("varsha", "9069562031",new Wallet(new BigDecimal(9000)));
	 Customer cust2=new Customer("Sachin", "7039931011",new Wallet(new BigDecimal(6000)));
			
	 data.put("9069562031", cust1);
	 data.put("7039931011", cust2);	
...
//TestCase1
	...
	public void testCreateAccount()       //mobile number is less than 10 digit
	{
		...
		wallet.createAccount("varsha", "1233",ob);
	}
	@org.junit.Test(expected=InvalidInputException.class)
	public void testCreateAccount2() 
	{
		BigDecimal ob=new BigDecimal(-12333);               //account opening balance cannot be negative
		wallet.createAccount("varsha", "9935393423",ob);
	}
	@org.junit.Test(expected=MobileNumberNotRegistered.class)// mobile number already registerd
	public void testCreateAccount3() 
	{
		BigDecimal ob=new BigDecimal(12333);
		wallet.createAccount("varsha", "9935393433",ob);
	}
	@org.junit.Test(expected=InvalidInputException.class)
	public void testCreateAccount4() 
	{
		BigDecimal ob=new BigDecimal(12333);
		wallet.createAccount("varsha", "992222222335393423",ob);  //mobile number format is not correct
	}
	@org.junit.Test(expected=InvalidInputException.class)
